...
var generateCombinedInterfaceAndNamedExports = exports.generateCombinedInterfaceAndNamedExports = function generateCombinedInterfaceAndNamedExports(cssModuleKeys, cleanedDefinitions, filename, indent) {
  var interfaceName = filenameToInterfaceName(filename);
  var interfaceProperties = cssModuleToTypescriptInterfaceProperties(cssModuleKeys, indent);
