...
module.exports = function (input) {
  ...
  this.async = function () {
    return function (err, content) {
      ...
      var logSkippedDefWarning = function logSkippedDefWarning() {
      ...
      if (query.namedExport && query.interface) {
        ...
        cssModuleDefinition = (0, _cssModuleToInterface.generateCombinedInterfaceAndNamedExports)(cssModuleKeys, cleanedDefinitions, filename);
